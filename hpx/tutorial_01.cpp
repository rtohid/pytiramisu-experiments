...
int main(int argc, char **argv)
{
    ...
    // Declare an iterator. The range of this iterator is [0, 1000000[
    // i.e., 0<=i<1000000
    var i("i", 0, 1000000);
    ...
    // Since the iterator i is declared to be 0<=i<1000000 (i.e., the iteration space of S0 is 0<=i<1000000),
    ...
    buffer buf0("buf0", {1000000}, p_uint8, a_output);
    ...
    // element (which is expr(1000000)), therefore the buffer only has one dimension
    // of size 1000000.
